...
\vspace{4pt}
\centerline{\fontsize{9.5}{12}\selectfont\color{muted}求职意向：Agent Harness 实习｜每周 4 天｜可实习 3 个月｜预计 9.16 可到岗}
\vspace{6pt}
...
\textbf{AI 协作开发：}Claude Code / Codex、OpenSpec 规范驱动开发、Git / GitHub 协作，具备多 Agent 任务拆解与协同开发实践。
